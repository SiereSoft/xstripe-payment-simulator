...
ITEMS = [
    folder("Admin", [
        ...
        req("Reset (seed=1)", "POST", "/v1/admin/reset",
            query={"seed": 1, "episode_id": "{{episodeId}}"}, no_auth=True,
            control=True),
    ...
    folder("Events", [
        req("List events for episode", "GET", "/v1/events",
            query={"limit": 10, "episode_id": "{{episodeId}}"}),
...
COLLECTION = {
    ...
    "variable": [
        ...
        {"key": "episodeId", "value": "postman-local-001"},
